...
key|加密字符串|string|必填|"格式为 MD5(uid + auth_code + total_amount + return_url + order_id)
...
channel|支付类型|string|支付通道，支付宝转银行卡当前仅会返回atb
...
```json
{
    ...
    "add_time": "2019-03-20 16:18:05.760568",
    "channel": "atb",
