...
money|金额|string|必填|发起付款的金额，单位：元，精确到小数点后两位。
channel|支付类型|string|必填|通道名称，当前支持参数有 拼多多-pdd 聚合码-nsm  当面付-ftf 转到银行卡-atb 支付宝免签-alipsn 微信免签-wxpsn。
...
order_money|订单金额|string|用户提交的金额
real_money|订单金额|string|用户实际支付的金额
